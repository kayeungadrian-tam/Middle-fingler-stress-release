...
class FingerDetector:
    ...
    def mid_finger_region(self, image, hand_landmarks):
        ...
        tip_pos = int(l[HandLandmark.MIDDLE_FINGER_TIP].x *
                      w), int(l[HandLandmark.MIDDLE_FINGER_TIP].y * h)
        mcp_pos = int(l[HandLandmark.MIDDLE_FINGER_MCP].x *
                      w), int(l[HandLandmark.MIDDLE_FINGER_MCP].y * h)
